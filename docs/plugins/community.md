...
This page tracks high-quality **community-maintained plugins** for paleoclaw.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `paleoclaw plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `paleoclaw plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect paleoclaw to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/paleoclaw-wechat`
  repo: `https://github.com/icesword0760/paleoclaw-wechat`
  install: `paleoclaw plugins install @icesword760/paleoclaw-wechat`
