...
# Plugin manifest (paleoclaw.plugin.json)

Every plugin **must** ship a `paleoclaw.plugin.json` file in the **plugin root**.
paleoclaw uses this manifest to validate configuration **without executing plugin
