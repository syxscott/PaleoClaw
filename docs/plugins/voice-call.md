...
Voice calls for paleoclaw via a plugin. Supports outbound notifications and
...
- Use `paleoclaw voicecall ...` or the `voice_call` tool
...
```bash
paleoclaw plugins install ./extensions/voice-call
