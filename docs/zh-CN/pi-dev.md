...
本指南总结了在 paleoclaw 中开发 Pi 集成的合理工作流程。
...
状态存储在 paleoclaw 状态目录下。默认为 `~/.paleoclaw`。如果设置了 `OPENCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.paleoclaw.ai/testing
- https://docs.paleoclaw.ai/start/getting-started
