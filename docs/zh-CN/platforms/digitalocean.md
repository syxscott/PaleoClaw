...
summary: 在 DigitalOcean 上运行 paleoclaw（简单的付费 VPS 选项）
title: DigitalOcean
x-i18n:
...
# 在 DigitalOcean 上运行 paleoclaw

## 目标

以 **$6/月**（或使用预留定价 $4/月）在 DigitalOcean 上运行持久的 paleoclaw Gateway 网关。
...
- `~/.paleoclaw/workspace/` — 工作区（SOUL.md、记忆等）
