...
summary: "`paleoclaw browser` 的 CLI 参考（配置文件、标签页、操作、扩展中继）"
title: browser
x-i18n:
...
管理 paleoclaw 的浏览器控制服务器并运行浏览器操作（标签页、快照、截图、导航、点击、输入）。
...
- `paleoclaw`：启动/附加到专用的 paleoclaw 管理的 Chrome 实例（隔离的用户数据目录）。
