...
summary: "`paleoclaw skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
- PaleoHub 安装：[PaleoHub](/tools/PaleoHub)

## 命令

```bash
paleoclaw skills list
paleoclaw skills list --eligible
paleoclaw skills info <name>
paleoclaw skills check
```
