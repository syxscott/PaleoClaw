...
Nostr is a decentralized protocol for social networking. This channel enables paleoclaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`paleoclaw onboard`) and `paleoclaw channels add` list optional channel plugins.
...
```bash
paleoclaw plugins install @paleoclaw/nostr
```

Use a local checkout (dev workflows):

```bash
paleoclaw plugins install --link <path-to-paleoclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "paleoclaw",
        "displayName": "paleoclaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "paleoclaw@example.com",
        "lud16": "paleoclaw@example.com"
      }
    }
  }
}
