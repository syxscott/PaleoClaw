...
- Install via CLI: `paleoclaw plugins install @paleoclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `paleoclaw plugins install ./extensions/zalo`
   - From npm (if published): `paleoclaw plugins install @paleoclaw/zalo`
...
- Approve via:
  - `paleoclaw pairing list zalo`
  - `paleoclaw pairing approve zalo <CODE>`
...
- Example: `paleoclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `paleoclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `paleoclaw logs --follow`
