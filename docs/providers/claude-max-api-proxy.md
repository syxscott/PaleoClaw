...
You can point paleoclaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or paleoclaw
...
- [Anthropic provider](/providers/anthropic) - Native paleoclaw integration with Claude setup-token or API keys
