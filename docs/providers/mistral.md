...
paleoclaw supports Mistral for both text/image model routing (`mistral/...`) and
...
```bash
paleoclaw onboard --auth-choice mistral-api-key
# or non-interactive
paleoclaw onboard --mistral-api-key "$MISTRAL_API_KEY"
```
