---
summary: "Use Qianfan's unified API to access many models in paleoclaw"
read_when:
...
3. paleoclaw installed on your system
...
4. Copy the API key for use with paleoclaw

## CLI setup

```bash
paleoclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [paleoclaw Configuration](/gateway/configuration)
