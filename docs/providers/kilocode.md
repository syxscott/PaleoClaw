---
summary: "Use Kilo Gateway's unified API to access many models in paleoclaw"
read_when:
  - You want a single API key for many LLMs
  - You want to run models via Kilo Gateway in paleoclaw
---
...
```bash
paleoclaw onboard --kilocode-api-key <key>
```
...
paleoclaw dynamically discovers available models from the Kilo Gateway at startup. Use
