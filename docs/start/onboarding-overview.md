...
paleoclaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`paleoclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the paleoclaw app when you want a fully guided setup on macOS. Docs:
