...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up paleoclaw?](#whats-the-recommended-way-to-install-and-set-up-paleoclaw)
  ...
  - [I can't access docs.paleoclaw.ai (SSL error). What now?](#i-cant-access-docsopenclawai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or paleoclaw not recognized](#windows-install-says-git-not-found-or-paleoclaw-not-recognized)
  ...
  - [How do I install paleoclaw on Linux?](#how-do-i-install-paleoclaw-on-linux)
  - [How do I install paleoclaw on a VPS?](#how-do-i-install-paleoclaw-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask paleoclaw to update itself?](#can-i-ask-paleoclaw-to-update-itself)
  ...
  - [If I buy a Mac mini to run paleoclaw, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-paleoclaw-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different paleoclaw instances?](#can-multiple-people-use-one-whatsapp-number-with-different-paleoclaw-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run paleoclaw on a dedicated machine?](#how-important-is-it-to-run-paleoclaw-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run paleoclaw in a VM and what are the requirements](#can-i-run-paleoclaw-in-a-vm-and-what-are-the-requirements)
- [What is paleoclaw?](#what-is-paleoclaw)
  - [What is paleoclaw, in one paragraph?](#what-is-paleoclaw-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for paleoclaw](#what-are-the-top-five-everyday-use-cases-for-paleoclaw)
  - [Can paleoclaw help with lead gen outreach ads and blogs for a SaaS](#can-paleoclaw-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can paleoclaw run tasks on a schedule or continuously in the background?](#can-paleoclaw-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with paleoclaw saved locally?](#is-all-data-used-with-paleoclaw-saved-locally)
  - [Where does paleoclaw store its data?](#where-does-paleoclaw-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall paleoclaw?](#how-do-i-completely-uninstall-paleoclaw)
...
- [Config basics](#config-basics)
  ...
  - [Can the paleoclaw browser run headless?](#can-the-paleoclaw-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two paleoclaw instances talk to each other (local + VPS)?](#can-two-paleoclaw-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does paleoclaw load environment variables?](#how-does-paleoclaw-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of paleoclaw instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-paleoclaw-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset paleoclaw but keep it installed?](#how-do-i-completely-reset-paleoclaw-but-keep-it-installed)
  ...
  - [Why doesn't paleoclaw reply in a group?](#why-doesnt-paleoclaw-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do paleoclaw, Flawd, and Krill use for models?](#what-do-paleoclaw-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `paleoclaw gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-paleoclaw-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `paleoclaw gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-paleoclaw-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run paleoclaw in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-paleoclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart paleoclaw?](#i-closed-my-terminal-on-windows-how-do-i-restart-paleoclaw)
  ...
  - [ELI5: `paleoclaw gateway restart` vs `paleoclaw gateway`](#eli5-paleoclaw-gateway-restart-vs-paleoclaw-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose paleoclaw to inbound DMs?](#is-it-safe-to-expose-paleoclaw-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/paleoclaw/paleoclaw-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   ```bash
   paleoclaw health --json
   paleoclaw health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://paleoclaw.ai/install.sh | bash -s -- --install-method git
```

This installs paleoclaw **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/paleoclaw/paleoclaw/issues](https://github.com/paleoclaw/paleoclaw/issues)
[https://github.com/paleoclaw/paleoclaw/pulls](https://github.com/paleoclaw/paleoclaw/pulls)

Start with these commands (share outputs when asking for help):

```bash
paleoclaw status
paleoclaw models status
paleoclaw doctor
```

What they do:

- `paleoclaw status`: quick snapshot of gateway/agent health + basic config.
- `paleoclaw models status`: checks provider auth + model availability.
- `paleoclaw doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `paleoclaw status --all`, `paleoclaw logs --follow`,
`paleoclaw gateway status`, `paleoclaw health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up paleoclaw
...
```bash
git clone https://github.com/paleoclaw/paleoclaw.git
cd paleoclaw
pnpm install
pnpm build
...
If you don't have a global install yet, run it via `pnpm paleoclaw onboard`.
...
- Retrieve it from the gateway host: `paleoclaw config get gateway.auth.token` (or generate one: `paleoclaw doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `paleoclaw gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy Control UI/WebSocket auth (no token, assumes trusted gateway host); HTTP APIs still require token/password.
- **Tailnet bind**: run `paleoclaw gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install paleoclaw on the new machine.
2. Copy `$OPENCLAW_STATE_DIR` (default: `~/.paleoclaw`) from the old machine.
3. Copy your workspace (default: `~/.paleoclaw/workspace`).
4. Run `paleoclaw doctor` and restart the Gateway service.
...
under `~/.paleoclaw/` (for example `~/.paleoclaw/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-paleoclaw-store-its-data),
...
[https://github.com/paleoclaw/paleoclaw/blob/main/CHANGELOG.md](https://github.com/paleoclaw/paleoclaw/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I can't access docs.paleoclaw.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.paleoclaw.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.paleoclaw.ai`, then retry. More
...
[https://github.com/paleoclaw/paleoclaw/tree/main/docs](https://github.com/paleoclaw/paleoclaw/tree/main/docs)
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://paleoclaw.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://paleoclaw.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://paleoclaw.ai/install.ps1](https://paleoclaw.ai/install.ps1)
...
```bash
curl -fsSL https://paleoclaw.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://paleoclaw.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://paleoclaw.ai/install.sh | bash -s -- --install-method git --verbose
```
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https://paleoclaw.ai/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or paleoclaw not recognized
...
**2) paleoclaw is not recognized after install**
...
If you still reproduce this on latest paleoclaw, track/report it in:

- [Issue #30640](https://github.com/paleoclaw/paleoclaw/issues/30640)
...
### How do I install paleoclaw on Linux
...
### How do I install paleoclaw on a VPS
...
### Can I ask paleoclaw to update itself
...
```bash
paleoclaw update
paleoclaw update status
paleoclaw update --channel stable|beta|dev
paleoclaw update --tag <dist-tag|version>
paleoclaw update --no-restart
```

If you must automate from an agent:

```bash
paleoclaw update --yes --no-restart
paleoclaw gateway restart
```
...
`paleoclaw onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run paleoclaw with **API keys** (Anthropic/OpenAI/others) or with
...
OpenAI Codex OAuth is explicitly supported for external tools like paleoclaw.
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `paleoclaw models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `paleoclaw models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `paleoclaw models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. paleoclaw no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so paleoclaw can keep replying while a provider is rate-limited.
...
paleoclaw supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.4` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. paleoclaw fully supports **OpenAI Code (Codex) subscription OAuth**.
OpenAI explicitly allows subscription OAuth usage in external tools/workflows
like paleoclaw. The onboarding wizard can run the OAuth flow for you.

See [OAuth](/concepts/oauth), [Model providers](/concepts/model-providers), and [Wizard](/start/wizard).

### How do I set up Gemini CLI OAuth

Gemini CLI uses a **plugin auth flow**, not a client id or secret in `paleoclaw.json`.

Steps:

1. Enable the plugin: `paleoclaw plugins enable google-gemini-cli-auth`
2. Login: `paleoclaw models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. paleoclaw needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.5 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. paleoclaw runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run paleoclaw can I connect it to my MacBook Pro
...
- Use `paleoclaw nodes status` / `paleoclaw nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but paleoclaw authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `paleoclaw logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different paleoclaw instances
...
If you run paleoclaw via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the paleoclaw code install. Your state
(`~/.paleoclaw`) and workspace (`~/.paleoclaw/workspace`) stay untouched.
...
**paleoclaw-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run paleoclaw on a dedicated machine
...
paleoclaw is lightweight. For a basic Gateway + one chat channel:
...
### Can I run paleoclaw in a VM and what are the requirements
...
### What is paleoclaw in one paragraph

paleoclaw is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

paleoclaw is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for paleoclaw
...
### Can paleoclaw help with lead gen outreach ads and blogs for a SaaS
...
paleoclaw draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

paleoclaw is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use paleoclaw when you
...
Showcase: [https://paleoclaw.ai/showcase](https://paleoclaw.ai/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.paleoclaw/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.paleoclaw/paleoclaw.json`). Precedence is `<workspace>/skills` > `~/.paleoclaw/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.paleoclaw/paleoclaw.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.paleoclaw/skills` → bundled → `skills.load.extraDirs`. `PaleoHub` installs into `./skills` by default, which paleoclaw treats as `<workspace>/skills`.
...
```bash
paleoclaw cron run <jobId> --force
paleoclaw cron runs --id <jobId> --limit 50
```
...
Use **PaleoHub** (CLI) or drop skills into your workspace. The macOS Skills UI isn't available on Linux.
Browse skills at [https://paleohub.org](https://paleohub.org).

Install the PaleoHub CLI (pick one package manager):
...
### Can paleoclaw run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.paleoclaw.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-paleoclaw-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. paleoclaw can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.paleoclaw/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "paleoclaw": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
PaleoHub installs into `./skills` under your current directory (or falls back to your configured paleoclaw workspace); paleoclaw treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.paleoclaw/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [PaleoHub](/tools/PaleoHub).
...
paleoclaw browser extension path
```
...
paleoclaw memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

paleoclaw also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, paleoclaw auto-selects a provider when it
...
configured and present, paleoclaw
...
### Is all data used with paleoclaw saved locally

No - **paleoclaw's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.paleoclaw` + your workspace directory).
...
### Where does paleoclaw store its data

Everything lives under `$OPENCLAW_STATE_DIR` (default: `~/.paleoclaw`):
...
Legacy single-agent path: `~/.paleoclaw/agent/*` (migrated by `paleoclaw doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.paleoclaw/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.paleoclaw`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.paleoclaw`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.paleoclaw/skills`).

Default workspace is `~/.paleoclaw/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.paleoclaw/workspace" } },
}
```
...
Do **not** commit anything under `~/.paleoclaw` (credentials, sessions, tokens, or encrypted secrets payloads).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall paleoclaw
...
`workspace` to the repo root. The paleoclaw repo is just source code; keep the
...
paleoclaw reads an optional **JSON5** config from `$OPENCLAW_CONFIG_PATH` (default: `~/.paleoclaw/paleoclaw.json`):

```
$OPENCLAW_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.paleoclaw/workspace`).
...
paleoclaw enforces token auth by default, including loopback. If no token is configured, gateway startup auto-generates one and saves it to `gateway.auth.token`, so **local WS clients must authenticate**. This blocks other local processes from calling the Gateway.

If you **really** want open loopback, set `gateway.auth.mode: "none"` explicitly in your config. Doctor can generate a token for you any time: `paleoclaw doctor --generate-gateway-token`.
...
- `default`: uses `All your chats, one paleoclaw.` every time.
...
key. **Recommended:** run `paleoclaw configure --section web` to store it in
...
- Daemons read env vars from `~/.paleoclaw/.env` (or the service environment).
...
### Can the paleoclaw browser run headless
...
5. Approve the node on the Gateway:
   ...
   ```bash
   paleoclaw devices list
   paleoclaw devices approve <requestId>
   ```
...
- Gateway is running: `paleoclaw gateway status`
- Gateway health: `paleoclaw status`
- Channel health: `paleoclaw channels status`
...
### Can two paleoclaw instances talk to each other local VPS
...
`paleoclaw agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
paleoclaw agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.paleoclaw/paleoclaw.json`).
- If you have no backup, re-run `paleoclaw doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `paleoclaw config set` for small changes.
- Use `paleoclaw configure` for interactive edits.
...
```bash
paleoclaw gateway --tailscale serve
```
...
### How does paleoclaw load environment variables

paleoclaw reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.paleoclaw/.env` (aka `$OPENCLAW_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.paleoclaw/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`paleoclaw models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means paleoclaw won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.paleoclaw/.env`:
...
### Is there a way to make a team of paleoclaw instances one CEO and many agents
...
### How do I completely reset paleoclaw but keep it installed
...
```bash
paleoclaw reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `OPENCLAW_PROFILE`), reset each state dir (defaults are `~/.paleoclaw-<profile>`).
- Dev reset: `paleoclaw gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), paleoclaw skips the heartbeat run to save API calls.
...
No. paleoclaw runs on **your own account**, so if you're in the group, paleoclaw can see it.
...
```bash
paleoclaw directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesn't paleoclaw reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.paleoclaw/agents/<agentId>/sessions/`.
...
- Use `paleoclaw doctor` to spot stray workspaces and profile mismatches.
...
paleoclaw's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, paleoclaw currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `paleoclaw models set ...` (updates just model config)
- `paleoclaw configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.paleoclaw/paleoclaw.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `paleoclaw doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do paleoclaw, Flawd, and Krill use for models

- These deployments can differ and may change over time; there is no fixed provider recommendation.
- Check the current runtime setting on each gateway with `paleoclaw models status`.
...
Yes. paleoclaw ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.paleoclaw/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `paleoclaw agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so paleoclaw can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.paleoclaw/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.paleoclaw/agent/*` (migrated by `paleoclaw doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.paleoclaw/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `paleoclaw models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `paleoclaw models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `paleoclaw models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.paleoclaw/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    paleoclaw models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), paleoclaw will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: paleoclaw now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
paleoclaw uses provider-prefixed IDs like:
...
paleoclaw may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `paleoclaw models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
paleoclaw models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
paleoclaw models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
paleoclaw models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
paleoclaw models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key what's the difference

paleoclaw supports both:
...
### Why does paleoclaw gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `paleoclaw gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does paleoclaw gateway status show Config cli and Config service different
...
```bash
paleoclaw gateway install --force
```
...
paleoclaw enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `paleoclaw gateway --port <port>`.

### How do I run paleoclaw in remote mode client connects to a Gateway elsewhere
...
- `paleoclaw gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- Fastest: `paleoclaw dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `paleoclaw doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `OPENCLAW_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `paleoclaw status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- Use `paleoclaw --profile <name> …` per instance (auto-creates `~/.paleoclaw-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `paleoclaw --profile <name> gateway install`.

Profiles also suffix service names (`ai.paleoclaw.<profile>`; legacy `com.paleoclaw.*`, `paleoclaw-gateway-<profile>.service`, `paleoclaw Gateway (<profile>)`).
...
```
paleoclaw tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/paleoclaw/paleoclaw-YYYY-MM-DD.log
```
...
- macOS: `$OPENCLAW_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.paleoclaw/logs/...`; profiles use `~/.paleoclaw-<profile>/logs/...`)
- Linux: `journalctl --user -u paleoclaw-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "paleoclaw Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `paleoclaw gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart paleoclaw
...
1. Is the Gateway running? `paleoclaw gateway status`
2. Is the Gateway healthy? `paleoclaw status`
3. Does the UI have the right token? `paleoclaw dashboard`
...
```bash
paleoclaw channels status
paleoclaw channels logs --channel telegram
```
...
### ELI5 paleoclaw gateway restart vs paleoclaw gateway

- `paleoclaw gateway restart`: restarts the **background service** (launchd/systemd).
- `paleoclaw gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `paleoclaw gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [paleoclaw assistant setup](/start/paleoclaw) and [Agent send](/tools/agent-send).

CLI sending:

```bash
paleoclaw message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose paleoclaw to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `paleoclaw pairing approve --channel <channel> [--account <id>] <code>`
  - Pending requests are capped at **3 per channel**; check `paleoclaw pairing list --channel <channel> [--account <id>]` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `paleoclaw doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. paleoclaw only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
paleoclaw pairing approve whatsapp <code>
```

List pending requests:

```bash
paleoclaw pairing list whatsapp
```
...
paleoclaw blocks **cross-provider** messaging by default. If a tool call is bound
