...
```bash
paleoclaw onboard
paleoclaw onboard --flow quickstart
paleoclaw onboard --flow manual
paleoclaw onboard --mode remote --remote-url wss://gateway-host:18789
```
...
- Fastest first chat: `paleoclaw dashboard` (Control UI, no channel setup).
