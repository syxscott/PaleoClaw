...
```bash
paleoclaw memory status
paleoclaw memory status --deep
paleoclaw memory index --force
paleoclaw memory search "meeting notes"
paleoclaw memory search --query "deployment" --max-results 20
paleoclaw memory status --json
paleoclaw memory status --deep --index
paleoclaw memory status --deep --index --verbose
paleoclaw memory status --agent main
paleoclaw memory index --agent main --verbose
```
