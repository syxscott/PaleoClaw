...
paleoclaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, paleoclaw also aligns
the install method:
...
When you switch channels with `paleoclaw update`, paleoclaw also syncs plugin sources:
