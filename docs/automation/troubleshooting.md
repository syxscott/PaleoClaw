...
paleoclaw system heartbeat last
paleoclaw logs --follow
paleoclaw config get agents.defaults.heartbeat
paleoclaw channels status --probe
```
...
```bash
paleoclaw config get agents.defaults.heartbeat.activeHours
paleoclaw config get agents.defaults.heartbeat.activeHours.timezone
paleoclaw config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
paleoclaw cron list
paleoclaw logs --follow
```
