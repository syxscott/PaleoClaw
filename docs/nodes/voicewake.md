...
paleoclaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.paleoclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["paleoclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
