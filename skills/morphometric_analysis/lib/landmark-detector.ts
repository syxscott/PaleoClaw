 ...
 */
export function detectLandmarks(contour: Point2D[], numLandmarks: number = 64): Landmark[] {
 ...
 * @returns Array of landmarks
 */
export function detectAllLandmarks(contour: Point2D[], numLandmarks: number = 64): Landmark[] {
