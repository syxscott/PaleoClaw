...
- Or set `skills."nano-banana-pro".apiKey` / `skills."nano-banana-pro".env.GEMINI_API_KEY` in `~/.paleoclaw/paleoclaw.json`
...
- The script prints a `MEDIA:` line for paleoclaw to auto-attach on supported chat providers.
