    ...
    <section class="card usage-header ${props.headerPinned ? "pinned" : ""}">
      <div class="usage-header-row">
        <div class="usage-header-title">
          ...
          ${props.loading ? html` <span class="usage-refresh-indicator">Loading</span> ` : nothing}
          ${isEmpty
            ? html`
            ...
            <div class="usage-export-popover">
              <div class="usage-export-list">
                <button
                  ...
                  @click=${() =>
                    downloadTextFile(
                      `paleoclaw-usage-sessions-${exportStamp}.csv`,
                ...
                <button
                  ...
                  @click=${() =>
                    downloadTextFile(
                      `paleoclaw-usage-daily-${exportStamp}.csv`,
                ...
                <button
                  ...
                  @click=${() =>
                    downloadTextFile(
                      `paleoclaw-usage-${exportStamp}.json`,
                      JSON.stringify(
                        {
      ...
      <div style="margin-top: 12px;">
        ...
        <div class="usage-filter-row">
          ...
          <span class="usage-query-hint"> Tip: use filters or click bars to filter days. </span>
        </div>
        ${queryTerms.length > 0
          ? html`
