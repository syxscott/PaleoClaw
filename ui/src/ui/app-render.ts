        ...
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src=${basePath ? `${basePath}/favicon.svg` : "/favicon.svg"} alt="paleoclaw" />
            </div>
            <div class="brand-text">
              <div class="brand-title">paleoclaw</div>
        ...
        <div class="nav-group nav-group--links">
          ...
          <div class="nav-group__items">
            <a
              ...
              href="https://www.paleoclaw.paleo-lab.com/manual.html"
      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        ${availableUpdate
          ? html`<div class="update-banner callout danger" role="alert">
              <strong>Update available:</strong> v${availableUpdate.latestVersion} (running
