...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.paleoclaw/paleoclaw.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde paleoclaw dashboard --no-open en tu escritorio.",
    },
    insecure: {
