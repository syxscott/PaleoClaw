...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.paleoclaw/paleoclaw.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von paleoclaw dashboard --no-open auf Ihrem Desktop.",
    },
    insecure: {
