...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@paleoclaw", { botUsername: "paleoclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@paleoclaw args", {
        botUsername: "paleoclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@paleoclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "paleoclaw" })).toBe(
      "/help@otherbot",
    );
  });
