...
export async function onTimer(state: CronServiceState) {
  if (state.running) {
    ...
    // execution to finish.
    // See: https://github.com/paleoclaw/paleoclaw/issues/12025
...
> {
    ...
    if (job.wakeMode === "now" && state.deps.runHeartbeatOnce) {
      ...
      for (;;) {
        ...
        heartbeatResult = await state.deps.runHeartbeatOnce({
          ...
          // See: https://github.com/paleoclaw/paleoclaw/issues/28508
  ...
  // See: https://github.com/paleoclaw/paleoclaw/issues/15692
  //
  ...
  // See: https://github.com/paleoclaw/paleoclaw/issues/32013
