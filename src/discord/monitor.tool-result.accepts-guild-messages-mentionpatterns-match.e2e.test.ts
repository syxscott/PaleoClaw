  ...
  return {
    agents: {
      defaults: {
        ...
        workspace: "/tmp/paleoclaw",
      },
    },
    session: { store: "/tmp/paleoclaw-sessions.json" },
...
describe("discord tool result dispatch", () => {
  it(
    ...
    async () => {
      ...
      await handler(
        createGuildMessageEvent({ messageId: "m2", content: "paleoclaw: hello" }),
        client,
      );
      ...
      createGuildMessageEvent({
        ...
        messagePatch: {
          referencedMessage: {
            ...
            author: { id: "bot-id", bot: true, username: "paleoclaw" },
          },
        },
        eventPatch: {
