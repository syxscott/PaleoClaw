...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    ...
    process.env.OPENCLAW_STATE_DIR = "/tmp/paleoclaw-cli-state";
    process.env.OPENCLAW_CONFIG_PATH = "/tmp/paleoclaw-cli-state/paleoclaw.json";
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        ...
        OPENCLAW_STATE_DIR: "/tmp/paleoclaw-daemon-state",
        OPENCLAW_CONFIG_PATH: "/tmp/paleoclaw-daemon-state/paleoclaw.json",
        OPENCLAW_GATEWAY_PORT: "19001",
      },
      sourcePath: "/tmp/ai.paleoclaw.gateway.plist",
    });
