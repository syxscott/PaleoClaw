    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["paleoclaw directory self --channel slack", "Show the connected account identity."],
          [
            'paleoclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["paleoclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "paleoclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.paleoclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
