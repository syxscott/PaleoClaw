      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["paleoclaw gateway run", "Run the gateway in the foreground."],
            ["paleoclaw gateway status", "Show service status and probe reachability."],
            ["paleoclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["paleoclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.paleoclaw.ai/cli/gateway")}\n`,
      ),
  );
