...
const SANDBOX_EXAMPLES = {
  main: [
    ["paleoclaw sandbox list", "List all sandbox containers."],
    ...
    ["paleoclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["paleoclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["paleoclaw sandbox list", "List all sandbox containers."],
    ["paleoclaw sandbox list --browser", "List only browser containers."],
  ...
  explain: [
    ["paleoclaw sandbox explain", "Show effective sandbox config."],
    ["paleoclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["paleoclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["paleoclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.paleoclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
