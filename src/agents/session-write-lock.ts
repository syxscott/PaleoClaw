...
const CLEANUP_STATE_KEY = Symbol.for("paleoclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("paleoclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("paleoclaw.sessionWriteLockWatchdogState");
