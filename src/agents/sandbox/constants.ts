...
export const DEFAULT_SANDBOX_IMAGE = "paleoclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "paleoclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "paleoclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "paleoclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "paleoclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "paleoclaw-sandbox-browser";
