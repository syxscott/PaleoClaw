...
const TRANSIENT_HTTP_ERROR_CODES = new Set([408, 425, 500, 502, 503, 504, 521, 522, 523, 524, 529]);
...
export function isModelNotFoundErrorMessage(raw: string): boolean {
  ...
  // Direct pattern matches from paleoclaw internals and common providers.
  if (
