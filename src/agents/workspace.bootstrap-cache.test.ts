...
describe("workspace bootstrap file caching", () => {
  ...
  beforeEach(async () => {
    workspaceDir = await makeTempWorkspace("paleoclaw-bootstrap-cache-test-");
  });
  ...
  it("caches files independently by path", async () => {
    ...
    const workspace1 = await makeTempWorkspace("paleoclaw-cache-test1-");
    const workspace2 = await makeTempWorkspace("paleoclaw-cache-test2-");
