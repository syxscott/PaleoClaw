...
Hooks can be configured in `~/.paleoclaw/paleoclaw.json`:
...
2. Restart gateway: `pkill -9 -f 'paleoclaw.*gateway' && pnpm paleoclaw gateway`
3. Enable the hook: `paleoclaw hooks enable my-hook`
4. Trigger the event (e.g., send `/new` command)
5. Check gateway logs for hook execution

## Documentation

Full documentation: https://docs.paleoclaw.ai/automation/hooks
