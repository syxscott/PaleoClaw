...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("paleoclaw");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "paleoclaw");
