...
import { resolveOpenClawPackageRoot, resolveOpenClawPackageRootSync } from "./paleoclaw-root.js";
...
export async function resolveControlUiDistIndexPath(
  ...
  // Fallback: traverse up and find package.json with name "paleoclaw" + dist/control-ui/index.html
...
export function resolveControlUiRootSync(opts: ControlUiRootResolveOptions = {}): string | null {
  ...
  if (argv1Dir) {
    // paleoclaw.mjs or dist/<bundle>.js
