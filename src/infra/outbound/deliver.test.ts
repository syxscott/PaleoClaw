...
import { resolvePreferredOpenClawTmpDir } from "../tmp-paleoclaw-dir.js";
...
describe("deliverOutboundPayloads", () => {
  ...
  it("includes paleoclaw tmp root in telegram mediaLocalRoots", async () => {
    const sendTelegram = vi.fn().mockResolvedValue({ messageId: "m1", chatId: "c1" });
  ...
  it("includes paleoclaw tmp root in signal mediaLocalRoots", async () => {
  ...
  it("includes paleoclaw tmp root in whatsapp mediaLocalRoots", async () => {
    const sendWhatsApp = vi.fn().mockResolvedValue({ messageId: "w1", toJid: "jid" });
  ...
  it("includes paleoclaw tmp root in imessage mediaLocalRoots", async () => {
