...
describe("modelsAuthLoginCommand", () => {
  ...
  beforeEach(() => {
    ...
    mocks.resolveAgentDir.mockReturnValue("/tmp/paleoclaw/agents/main");
    mocks.resolveAgentWorkspaceDir.mockReturnValue("/tmp/paleoclaw/workspace");
    mocks.resolveDefaultAgentWorkspaceDir.mockReturnValue("/tmp/paleoclaw/workspace");
