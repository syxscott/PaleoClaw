...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.paleoclaw.gateway\n";
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.paleoclaw.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.paleoclaw.ai/gateway");
  });
  ...
  it.each([
    {
      ...
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.paleoclaw.gateway.plist",
    },
    {
      ...
      expected: "/Users/test/Library/LaunchAgents/ai.paleoclaw.jbphoenix.plist",
    },
    {
    ...
    },
    {
      ...
      expected: "/Users/test/Library/LaunchAgents/ai.paleoclaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
