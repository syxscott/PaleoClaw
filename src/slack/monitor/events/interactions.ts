...
// Prefix for paleoclaw-generated action IDs to scope our handler
const OPENCLAW_ACTION_PREFIX = "paleoclaw:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  // Handle Block Kit button clicks from paleoclaw-generated messages
  ...
  // Handle paleoclaw modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
