...
import type {
  ...
  ChannelSetupInput,
  OpenClawConfig,
} from "paleoclaw/plugin-sdk/tlon";
import {
...
export const tlonPlugin: ChannelPlugin = {
  ...
  status: {
    ...
    buildAccountSnapshot: ({ account, runtime, probe }) => {
      ...
      return snapshot as import("paleoclaw/plugin-sdk/tlon").ChannelAccountSnapshot;
    },
  },
  gateway: {
    startAccount: async (ctx) => {
      ...
      ctx.setStatus({
        ...
        ship: account.ship,
        url: account.url,
      } as import("paleoclaw/plugin-sdk/tlon").ChannelAccountSnapshot);
