...
// Default to paleoclaw workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".paleoclaw", "workspace", "media", "inbound");
 ...
 * Format matches paleoclaw's expected attachment structure.
 */
