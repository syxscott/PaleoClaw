...
Docs: `https://docs.paleoclaw.ai/plugins/voice-call`
Plugin system: `https://docs.paleoclaw.ai/plugin`

## Install (local dev)

### Option A: install via paleoclaw (recommended)
...
```bash
mkdir -p ~/.paleoclaw/extensions
cp -R extensions/voice-call ~/.paleoclaw/extensions/voice-call
cd ~/.paleoclaw/extensions/voice-call && pnpm install
```
...
```bash
paleoclaw voicecall call --to "+15555550123" --message "Hello from paleoclaw"
paleoclaw voicecall continue --call-id <id> --message "Any questions?"
paleoclaw voicecall speak --call-id <id> --message "One moment"
paleoclaw voicecall end --call-id <id>
paleoclaw voicecall status --call-id <id>
paleoclaw voicecall tail
