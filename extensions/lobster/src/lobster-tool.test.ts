...
import type { OpenClawPluginApi, OpenClawPluginToolContext } from "paleoclaw/plugin-sdk/lobster";
...
describe("lobster plugin tool", () => {
  ...
  beforeAll(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "paleoclaw-lobster-plugin-"));
  });
