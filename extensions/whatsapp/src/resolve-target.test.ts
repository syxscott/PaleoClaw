...
vi.mock("paleoclaw/plugin-sdk/whatsapp", async () => {
  const actual = await vi.importActual<typeof import("paleoclaw/plugin-sdk/whatsapp")>(
    "paleoclaw/plugin-sdk/whatsapp",
  );
