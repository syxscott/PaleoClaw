...
extension ProcessInfo {
    ...
    /// Nix deployments may write defaults into a stable suite (`ai.paleoclaw.mac`) even if the shipped
        ...
        isAppBundle: Bool) -> Bool
    {
        ...
        if standard.bool(forKey: "paleoclaw.nixMode") { return true }
        ...
        if isAppBundle, let stableSuite, stableSuite.bool(forKey: "paleoclaw.nixMode") { return true }
