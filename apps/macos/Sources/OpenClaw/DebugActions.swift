...
enum DebugActions {
    private static let verboseDefaultsKey = "paleoclaw.debug.verboseMain"
    private static let sessionMenuLimit = 12
    private static let onboardingSeenKey = "paleoclaw.onboardingSeen"
    ...
    static func sendTestNotification() async {
        _ = await NotificationManager().send(title: "paleoclaw", body: "Test notification", sound: nil)
    }
