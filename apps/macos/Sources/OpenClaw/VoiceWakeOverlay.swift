...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.paleoclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other paleoclaw windows, but below the system’s pop-up menus.
