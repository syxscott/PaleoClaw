...
actor GatewayEndpointStore {
    ...
    private static let staticLogger = Logger(subsystem: "ai.paleoclaw", category: "gateway-endpoint")
    ...
    private let logger = Logger(subsystem: "ai.paleoclaw", category: "gateway-endpoint")
    ...
    init(deps: Deps = .live) {
        ...
        if let modeRaw {
            ...
            let seen = UserDefaults.standard.bool(forKey: "paleoclaw.onboardingSeen")
