...
final class PeekabooBridgeHostCoordinator {
    ...
    private let logger = Logger(subsystem: "ai.paleoclaw", category: "PeekabooBridge")
    ...
    private static var openclawSocketPath: String {
        ...
        return Self.makeSocketPath(for: "paleoclaw", in: base)
    }
...
private final class OpenClawPeekabooBridgeServices: PeekabooBridgeServiceProviding {
    ...
    init() {
        let logging = LoggingService(subsystem: "ai.paleoclaw.peekaboo")
