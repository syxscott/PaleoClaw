...
final class ControlChannel {
    ...
    private let logger = Logger(subsystem: "ai.paleoclaw", category: "control")
...
extension Notification.Name {
    static let controlHeartbeat = Notification.Name("paleoclaw.control.heartbeat")
    static let controlAgentEvent = Notification.Name("paleoclaw.control.agent")
}
