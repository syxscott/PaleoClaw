...
public final class GatewayDiscoveryModel {
    ...
    private let logger = Logger(subsystem: "ai.paleoclaw", category: "gateway-discovery")
    ...
    public func start() {
        ...
        for domain in OpenClawBonjour.gatewayServiceDomains {
            let browser = GatewayDiscoveryBrowserSupport.makeBrowser(
                ...
                domain: domain,
                queueLabelPrefix: "ai.paleoclaw.macos.gateway-discovery",
    ...
    private nonisolated static func prettifyInstanceName(_ decodedName: String) -> String {
        ...
        let stripped = normalized.replacingOccurrences(of: " (paleoclaw)", with: "")
