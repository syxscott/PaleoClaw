...
struct OpenClawConfigFileTests {
    private func makeConfigOverridePath() -> String {
        FileManager().temporaryDirectory
            .appendingPathComponent("paleoclaw-config-\(UUID().uuidString)")
            .appendingPathComponent("paleoclaw.json")
            .path
    }
    ...
    func stateDirOverrideSetsConfigPath() async {
        let dir = FileManager().temporaryDirectory
            .appendingPathComponent("paleoclaw-state-\(UUID().uuidString)", isDirectory: true)
            .path
        ...
        await TestIsolation.withEnvValues([
            ...
            #expect(OpenClawConfigFile.url().path == "\(dir)/paleoclaw.json")
        }
    }
    ...
    func saveDictAppendsConfigAuditLog() async throws {
        let stateDir = FileManager().temporaryDirectory
            .appendingPathComponent("paleoclaw-state-\(UUID().uuidString)", isDirectory: true)
        let configPath = stateDir.appendingPathComponent("paleoclaw.json")
        ...
        try await TestIsolation.withEnvValues([
            ...
            #expect(auditRoot?["source"] as? String == "macos-paleoclaw-config-file")
