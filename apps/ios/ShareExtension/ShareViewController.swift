...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.paleoclaw.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to paleoclaw", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to paleoclaw gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to paleoclaw.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                ...
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "paleoclaw is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "paleoclaw Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("paleoclaw-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
