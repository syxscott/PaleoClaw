...
struct SettingsTab: View {
    ...
    private let gatewayLogger = Logger(subsystem: "ai.paleoclaw.ios", category: "GatewaySettings")
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected paleoclaw agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while paleoclaw is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for paleoclaw. "
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while paleoclaw is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("paleoclaw", value: DeviceInfoHelper.openClawVersionString())
                    }
                }
            }
