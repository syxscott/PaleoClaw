...
final class OpenClawAppDelegate: NSObject, UIApplicationDelegate, @preconcurrency UNUserNotificationCenterDelegate {
    private let logger = Logger(subsystem: "ai.paleoclaw.ios", category: "Push")
    private let backgroundWakeLogger = Logger(subsystem: "ai.paleoclaw.ios", category: "BackgroundWake")
    private static let wakeRefreshTaskIdentifier = "ai.paleoclaw.ios.bgrefresh"
...
enum WatchPromptNotificationBridge {
    static let typeKey = "paleoclaw.type"
    static let typeValue = "watch.prompt"
    static let promptIDKey = "paleoclaw.watch.promptId"
    static let sessionKeyKey = "paleoclaw.watch.sessionKey"
    static let actionPrimaryIDKey = "paleoclaw.watch.action.primary.id"
    static let actionPrimaryLabelKey = "paleoclaw.watch.action.primary.label"
    static let actionSecondaryIDKey = "paleoclaw.watch.action.secondary.id"
    static let actionSecondaryLabelKey = "paleoclaw.watch.action.secondary.label"
    static let actionPrimaryIdentifier = "paleoclaw.watch.action.primary"
    static let actionSecondaryIdentifier = "paleoclaw.watch.action.secondary"
    static let actionIdentifierPrefix = "paleoclaw.watch.action."
    static let actionIDKeyPrefix = "paleoclaw.watch.action.id."
    static let actionLabelKeyPrefix = "paleoclaw.watch.action.label."
    static let categoryPrefix = "paleoclaw.watch.prompt.category."
        ...
        sendResult: WatchNotificationSendResult) async
    {
        ...
        content.title = title.isEmpty ? "paleoclaw" : title
        content.body = body
...
extension OpenClawApp {
    private static func installUncaughtExceptionLogger() {
        NSLog("paleoclaw: installing uncaught exception handler")
