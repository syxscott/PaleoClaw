...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.paleoclaw.gateway"
    private static let nodeService = "ai.paleoclaw.node"
    private static let talkService = "ai.paleoclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.paleoclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.paleoclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("paleoclaw-gateway.log")
    }
