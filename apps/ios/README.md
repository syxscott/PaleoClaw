...
This iPhone app is super-alpha and internal-use only. It connects to an paleoclaw Gateway as a `role: node`.
...
- `apps/ios/Sources/paleoclaw.entitlements` sets `aps-environment` to `development`.
