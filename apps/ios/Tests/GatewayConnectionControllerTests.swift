...
@Suite(.serialized) struct GatewayConnectionControllerTests {
    ...
    @Test @MainActor func loadLastConnectionReadsSavedValues() {
        let prior = KeychainStore.loadString(service: "ai.paleoclaw.gateway", account: "lastConnection")
        defer {
            if let prior {
                _ = KeychainStore.saveString(prior, service: "ai.paleoclaw.gateway", account: "lastConnection")
            } else {
                _ = KeychainStore.delete(service: "ai.paleoclaw.gateway", account: "lastConnection")
            }
        }
        _ = KeychainStore.delete(service: "ai.paleoclaw.gateway", account: "lastConnection")
