...
if [[ -z "$version_content" ]]; then
  echo "<h2>paleoclaw $VERSION</h2>"
  echo "<p>Latest paleoclaw update.</p>"
  echo "<p><a href=\"https://github.com/paleoclaw/paleoclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
