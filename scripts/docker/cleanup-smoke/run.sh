...
export OPENCLAW_STATE_DIR="/tmp/paleoclaw-test"
...
pnpm paleoclaw reset --scope config+creds+sessions --yes --non-interactive
...
pnpm paleoclaw uninstall --state --yes --non-interactive
