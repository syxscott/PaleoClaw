...
# Output:
# - dist/paleoclaw.app
# - dist/paleoclaw-<version>.zip
# - dist/paleoclaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.paleoclaw.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/paleoclaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/paleoclaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/paleoclaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/paleoclaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/paleoclaw-$VERSION.dSYM.zip"
