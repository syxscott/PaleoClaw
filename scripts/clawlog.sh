...
show_usage() {
    cat << EOF
clawlog - paleoclaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View paleoclaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    paleoclaw logs flow through the macOS unified log (subsystem: ai.paleoclaw).
